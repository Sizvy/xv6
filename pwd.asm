...
static int getcwd(char* resultPath) {
  ...
  strcpy(ancestorPath, ".");
  13:	8d 9d f8 fd ff ff    	lea    -0x208(%ebp),%ebx
int main(int argc, char *argv[]) {
  19:	81 ec 28 04 00 00    	sub    $0x428,%esp
  resultPath[0] = '\0';
  1f:	c6 85 f8 fb ff ff 00 	movb   $0x0,-0x408(%ebp)
  strcpy(ancestorPath, ".");
  26:	68 1a 09 00 00       	push   $0x91a
  2b:	53                   	push   %ebx
  2c:	e8 9f 01 00 00       	call   1d0 <strcpy>

  struct stat st;
  if (stat(ancestorPath, &st) < 0)
  31:	58                   	pop    %eax
  32:	8d 85 e4 fb ff ff    	lea    -0x41c(%ebp),%eax
  38:	5a                   	pop    %edx
  39:	50                   	push   %eax
  3a:	53                   	push   %ebx
  3b:	e8 30 03 00 00       	call   370 <stat>
  40:	83 c4 10             	add    $0x10,%esp
  43:	85 c0                	test   %eax,%eax
  45:	78 39                	js     80 <main+0x80>
    return FALSE;

  char* p = goUp(st.ino, ancestorPath, resultPath);
  47:	8b 85 ec fb ff ff    	mov    -0x414(%ebp),%eax
  4d:	8d 8d f8 fb ff ff    	lea    -0x408(%ebp),%ecx
  53:	89 da                	mov    %ebx,%edx
  55:	e8 56 00 00 00       	call   b0 <goUp>
  if (p == NULL)
  5a:	85 c0                	test   %eax,%eax
  5c:	74 22                	je     80 <main+0x80>
    return FALSE;
  if (resultPath[0] == '\0')
  5e:	80 bd f8 fb ff ff 00 	cmpb   $0x0,-0x408(%ebp)
  65:	74 2f                	je     96 <main+0x96>
    printf(1, "%s\n", resultPath);
  67:	50                   	push   %eax
  68:	8d 85 f8 fb ff ff    	lea    -0x408(%ebp),%eax
  6e:	50                   	push   %eax
  6f:	68 29 09 00 00       	push   $0x929
  74:	6a 01                	push   $0x1
  76:	e8 35 05 00 00       	call   5b0 <printf>
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	eb 11                	jmp    91 <main+0x91>
    printf(2, "pwd failed");
  80:	51                   	push   %ecx
  81:	51                   	push   %ecx
  82:	68 1e 09 00 00       	push   $0x91e
  87:	6a 02                	push   $0x2
  89:	e8 22 05 00 00       	call   5b0 <printf>
  8e:	83 c4 10             	add    $0x10,%esp
  exit();
  91:	e8 9d 03 00 00       	call   433 <exit>
    strcpy(resultPath, PATH_SEPARATOR);
  96:	8d 85 f8 fb ff ff    	lea    -0x408(%ebp),%eax
  9c:	52                   	push   %edx
  9d:	52                   	push   %edx
  9e:	68 1c 09 00 00       	push   $0x91c
  a3:	50                   	push   %eax
  a4:	e8 27 01 00 00       	call   1d0 <strcpy>
  a9:	83 c4 10             	add    $0x10,%esp
  ac:	eb b9                	jmp    67 <main+0x67>
  ae:	66 90                	xchg   %ax,%ax
...
static char* goUp(int ino, char* ancestorPath, char* resultPath) {
  ...
  b3:	57                   	push   %edi
  b4:	89 cf                	mov    %ecx,%edi
  b6:	56                   	push   %esi
  b7:	89 c6                	mov    %eax,%esi
  b9:	53                   	push   %ebx
  ba:	89 d3                	mov    %edx,%ebx
  bc:	83 ec 58             	sub    $0x58,%esp
  strcpy(ancestorPath + strlen(ancestorPath), PATH_SEPARATOR "..");
  bf:	52                   	push   %edx
  c0:	e8 8b 01 00 00       	call   250 <strlen>
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 18 09 00 00       	push   $0x918
  cc:	01 d8                	add    %ebx,%eax
  ce:	50                   	push   %eax
  cf:	e8 fc 00 00 00       	call   1d0 <strcpy>
  struct stat st;
  if (stat(ancestorPath, &st) < 0)
  d4:	58                   	pop    %eax
  d5:	8d 45 d4             	lea    -0x2c(%ebp),%eax
  d8:	5a                   	pop    %edx
  d9:	50                   	push   %eax
  da:	53                   	push   %ebx
  db:	e8 90 02 00 00       	call   370 <stat>
  e0:	83 c4 10             	add    $0x10,%esp
  e3:	85 c0                	test   %eax,%eax
  e5:	0f 88 b5 00 00 00    	js     1a0 <goUp+0xf0>
    return NULL;

  if (st.ino == ino) {
  eb:	39 75 dc             	cmp    %esi,-0x24(%ebp)
  ee:	0f 84 99 00 00 00    	je     18d <goUp+0xdd>
  ...
  f7:	6a 00                	push   $0x0
  f9:	53                   	push   %ebx
  fa:	e8 74 03 00 00       	call   473 <open>
  if (fd >= 0) {
  ff:	83 c4 10             	add    $0x10,%esp
  int fd = open(ancestorPath, O_RDONLY);
 102:	89 45 b4             	mov    %eax,-0x4c(%ebp)
  if (fd >= 0) {
 105:	85 c0                	test   %eax,%eax
 107:	0f 88 93 00 00 00    	js     1a0 <goUp+0xf0>
    char* p = goUp(st.ino, ancestorPath, resultPath);
 10d:	8b 45 dc             	mov    -0x24(%ebp),%eax
 110:	89 f9                	mov    %edi,%ecx
 112:	89 da                	mov    %ebx,%edx
 114:	e8 97 ff ff ff       	call   b0 <goUp>
 119:	89 c7                	mov    %eax,%edi
    if (p != NULL) {
 11b:	85 c0                	test   %eax,%eax
 11d:	74 60                	je     17f <goUp+0xcf>
      strcpy(p, PATH_SEPARATOR);
 11f:	83 ec 08             	sub    $0x8,%esp
 122:	8d 5d c4             	lea    -0x3c(%ebp),%ebx
 125:	68 1c 09 00 00       	push   $0x91c
 12a:	50                   	push   %eax
 12b:	e8 a0 00 00 00       	call   1d0 <strcpy>
  return foundPath;
}
...
static int dirlookup(int fd, int ino, char* p) {
 ...
 13b:	6a 10                	push   $0x10
 13d:	53                   	push   %ebx
 13e:	ff 75 b4             	pushl  -0x4c(%ebp)
 141:	e8 05 03 00 00       	call   44b <read>
 146:	83 c4 10             	add    $0x10,%esp
 149:	83 f8 10             	cmp    $0x10,%eax
 14c:	75 62                	jne    1b0 <goUp+0x100>
    if (de.inum == 0)
 14e:	0f b7 45 c4          	movzwl -0x3c(%ebp),%eax
 152:	66 85 c0             	test   %ax,%ax
 155:	74 e1                	je     138 <goUp+0x88>
      continue;
    if (de.inum == ino) {
 157:	39 c6                	cmp    %eax,%esi
 159:	75 dd                	jne    138 <goUp+0x88>
      memmove(p, de.name, DIRSIZ);
 15b:	83 ec 04             	sub    $0x4,%esp
      p += sizeof(PATH_SEPARATOR) - 1;
 15e:	8d 5f 01             	lea    0x1(%edi),%ebx
      memmove(p, de.name, DIRSIZ);
 161:	8d 45 c6             	lea    -0x3a(%ebp),%eax
 164:	6a 0e                	push   $0xe
 166:	50                   	push   %eax
 167:	53                   	push   %ebx
 168:	e8 93 02 00 00       	call   400 <memmove>
      p[DIRSIZ] = '\0';
 16d:	c6 47 0f 00          	movb   $0x0,0xf(%edi)
        foundPath = p + strlen(p);
 171:	89 1c 24             	mov    %ebx,(%esp)
 174:	e8 d7 00 00 00       	call   250 <strlen>
 179:	83 c4 10             	add    $0x10,%esp
 17c:	8d 3c 03             	lea    (%ebx,%eax,1),%edi
    close(fd);
 17f:	83 ec 0c             	sub    $0xc,%esp
 182:	ff 75 b4             	pushl  -0x4c(%ebp)
 185:	e8 d1 02 00 00       	call   45b <close>
 ...
 1b3:	ff 75 b4             	pushl  -0x4c(%ebp)
  char* foundPath = NULL;
 1b6:	31 ff                	xor    %edi,%edi
    close(fd);
 1b8:	e8 9e 02 00 00       	call   45b <close>
 1bd:	83 c4 10             	add    $0x10,%esp
 1c0:	eb cb                	jmp    18d <goUp+0xdd>
...
000004e3 <getarraySum>:
SYSCALL(getarraySum)
 4e3:	b8 18 00 00 00       	mov    $0x18,%eax
 4e8:	cd 40                	int    $0x40
 4ea:	c3                   	ret    

000004eb <getreadcount>:
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 539:	0f b6 92 34 09 00 00 	movzbl 0x934(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 734:	eb 1a                	jmp    750 <printf+0x1a0>
          s = "(null)";
 736:	bb 2d 09 00 00       	mov    $0x92d,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 785:	a1 20 0c 00 00       	mov    0xc20,%eax
{
 ...
 7a6:	73 10                	jae    7b8 <free+0x38>
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	a3 20 0c 00 00       	mov    %eax,0xc20
}
 7d7:	5e                   	pop    %esi
 7d8:	5f                   	pop    %edi
 7d9:	5d                   	pop    %ebp
 ...
 7f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7fa:	a3 20 0c 00 00       	mov    %eax,0xc20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 81d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 820:	8b 3d 20 0c 00 00    	mov    0xc20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 869:	8b 3d 20 0c 00 00    	mov    0xc20,%edi
 ...
 892:	e8 e9 fe ff ff       	call   780 <free>
  return freep;
 897:	a1 20 0c 00 00       	mov    0xc20,%eax
 ...
 8de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 20 0c 00 00 24 	movl   $0xc24,0xc20
 8e7:	0c 00 00 
    base.s.size = 0;
 8ea:	bf 24 0c 00 00       	mov    $0xc24,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 24 0c 00 00 24 	movl   $0xc24,0xc24
 8f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
