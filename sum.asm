...
int main(int argc, char const *argv[])
{
  ...
  38:	e8 03 04 00 00       	call   440 <printf>
    printf(1,"Sum is: %d\n",getSum(a,b));
  3d:	83 c4 18             	add    $0x18,%esp
  40:	56                   	push   %esi
  41:	53                   	push   %ebx
  42:	e8 24 03 00 00       	call   36b <getSum>
  47:	83 c4 0c             	add    $0xc,%esp
  4a:	50                   	push   %eax
  4b:	68 bc 07 00 00       	push   $0x7bc
  50:	6a 01                	push   $0x1
  52:	e8 e9 03 00 00       	call   440 <printf>
    exit();
  57:	e8 67 02 00 00       	call   2c3 <exit>
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 615:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 792:	00 00 00 
    if(p->s.size >= nunits){
